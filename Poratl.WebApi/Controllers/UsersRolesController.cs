...
namespace Poratl.WebApi.Controllers
{
    ...
    {
        #region Services
        private readonly IUsersRolesService _thisService;
        ...
        #region Constructor
        public UsersRolesController(IActionResultResponseHandler responseHandler, IRepositoryActionResult repositoryActionResult, IUsersRolesService thisService, IHttpContextAccessor httpContextAccessor, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment)
        ...
        [AllowAnonymous]
        [HttpPost(Api_Routes.UsersRoles.GetAll)]
        public async Task<IActionResult> GetAll([FromBody] BaseParam<UsersRolesFilter> filter)
        {
            try
            {
                var result = await _thisService.FindPagedAsync(a => a.Id > 0 && (filter.Filter.UserId==0 || filter.Filter.UserId == a.UserId),
        ...
        [AllowAnonymous]
        [HttpGet(Api_Routes.UsersRoles.Get)]
        public async Task<IActionResult> GetById([Required] int id)
        {
            try
            {
                var result = await _thisService.GetByIdAsync(id);
                return Ok(new SuccessResponse<ResUsersRolesVm>
                {
                    Code = 200,
                    Data = result
                });
        ...
        [HttpPost(Api_Routes.UsersRoles.Create)]
        public async Task<IActionResult> Add([FromBody] UsersRolesVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.UsersRoles.Update)]
        public async Task<IActionResult> Update([FromBody] UsersRolesVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.UsersRoles.Delete)]
        ...
        [HttpPost(Api_Routes.UsersRoles.DeleteList)]
