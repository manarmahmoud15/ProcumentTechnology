...
namespace Poratl.WebApi.Controllers
{
    ...
    {
        #region Services
        private readonly ICompanyService _thisService;
        ...
        #region Constructor
        public CompanyController(IActionResultResponseHandler responseHandler, IRepositoryActionResult repositoryActionResult, ICompanyService thisService, IHttpContextAccessor httpContextAccessor, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment)
        ...
        [AllowAnonymous]
        [HttpPost(Api_Routes.Company.GetAll)]
        public async Task<IActionResult> GetAll([FromBody] BaseParam<CompanyFilter> filter)
        {
            try
            {
        ...
        [AllowAnonymous]
        [HttpGet(Api_Routes.Company.Get)]
        public async Task<IActionResult> GetById([Required] int id)
        {
            try
            {
                var result = await _thisService.GetByIdAsync(id);
                return Ok(new SuccessResponse<ResCompanyVm>
                {
                    Code = 200,
                    Data = result
                });
        ...
        [HttpPost(Api_Routes.Company.Create)]
        public async Task<IActionResult> Add([FromBody] CompanyVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.Company.Update)]
        public async Task<IActionResult> Update([FromBody] CompanyVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.Company.Delete)]
        ...
        [HttpPost(Api_Routes.Company.DeleteList)]
