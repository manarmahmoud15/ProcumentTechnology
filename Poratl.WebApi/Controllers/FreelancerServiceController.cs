...
{
    [AllowAnonymous]
    public class FreelancerServiceController : ApiControllerBase
    {
        #region Services
        private readonly IFreelancerServiceService _thisService;
        ...
        #region Constructor
        public FreelancerServiceController(IActionResultResponseHandler responseHandler, IRepositoryActionResult repositoryActionResult, IFreelancerServiceService thisService, IHttpContextAccessor httpContextAccessor, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment)
        ...
        [AllowAnonymous]
        [HttpPost(Api_Routes.FreelancerService.GetAll)]
        public async Task<IActionResult> GetAll([FromBody] BaseParam<FreelancerServiceFilter> filter)
        {
            try
            {
        ...
        [AllowAnonymous]
        [HttpGet(Api_Routes.FreelancerService.Get)]
        public async Task<IActionResult> GetById([Required] int id)
        {
            try
            {
                var result = await _thisService.GetByIdAsync(id);
                return Ok(new SuccessResponse<ResFreelancerServiceVm>
                {
                    Code = 200,
                    Data = result
                });
        ...
        [HttpPost(Api_Routes.FreelancerService.Create)]
        public async Task<IActionResult> Add([FromBody] FreelancerServiceVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.FreelancerService.Update)]
        public async Task<IActionResult> Update([FromBody] FreelancerServiceVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.FreelancerService.Delete)]
        ...
        [HttpPost(Api_Routes.FreelancerService.DeleteList)]
