...
namespace Poratl.WebApi.Controllers
{
    ...
    {
        #region Services
        private readonly IReportService _thisService;
        ...
        #region Constructor
        public ReportController(IActionResultResponseHandler responseHandler, IRepositoryActionResult repositoryActionResult, IReportService thisService, IHttpContextAccessor httpContextAccessor, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment)
        ...
        [AllowAnonymous]
        [HttpPost(Api_Routes.Report.GetAll)]
        public async Task<IActionResult> GetAll([FromBody] BaseParam<ReportFilter> filter)
        {
            try
            {
        ...
        [AllowAnonymous]
        [HttpGet(Api_Routes.Report.Get)]
        public async Task<IActionResult> GetById([Required] int id)
        {
            try
            {
                var result = await _thisService.GetByIdAsync(id);
                return Ok(new SuccessResponse<ResReportVm>
                {
                    Code = 200,
                    Data = result
                });
        ...
        [AllowAnonymous]
        [HttpPost(Api_Routes.Report.Create)]
        public async Task<IActionResult> Add([FromBody] ReportVm parameter)
        {
        ...
        [AllowAnonymous]
        [HttpPost(Api_Routes.Report.Update)]
        public async Task<IActionResult> Update([FromBody] ReportVm parameter)
        {
            try
            {
        ...
        [HttpPost(Api_Routes.Report.Delete)]
        ...
        [HttpPost(Api_Routes.Report.DeleteList)]
